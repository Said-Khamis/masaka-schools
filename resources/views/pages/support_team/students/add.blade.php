...
@section('content')
        <div class="card">
            ...
            <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation" action="{{ route('students.store') }}" data-foucus>
               @csrf
                <h6>Personal data</h6>
                <fieldset>
                    <div class="row">
        ...
        <div class="card">
            <div class="card-header bg-white header-elements-inline">
                <h6 class="card-title font-weight-bold">Import Students From Excel</h6>
